...
const { listar, crear, actualizar, eliminar, resolver } = require('../controllers/planes.controller');

router.use(authMiddleware);

router.get('/',         requireRol('SUPERADMIN', 'ADMIN'), listar);
router.get('/resolver', requireRol('SUPERADMIN', 'ADMIN'), resolver);
